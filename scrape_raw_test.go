...
func TestScrapeJunniRaw1(t *testing.T) {
	...
	if assert.NoError(t, err) {
		...
		expectedTable := [][][]string{
			...
			{{""}, {"14"}, {"先崎\u3000学九段"}, {"5"}, {"3"}, {"○", "宮本"}, {"○", "阿部健"}, {"○", "高橋"}, {"●", "真田"}, {"●", "伊藤匠"}, {"○", "門倉"}, {"●", "黒田"}, {"○", "西田"}, {"－"}, {"", "北島"}, {"先", "千葉"}},
			{{""}, {"15"}, {"金井恒太六段"}, {"4"}, {"4"}, {"○", "千葉"}, {"●", "斎藤明"}, {"●", "阪口"}, {"○", "日浦"}, {"○", "船江"}, {"●", "西田"}, {"●", "飯塚"}, {"－"}, {"○", "窪田"}, {"先", "出口"}, {"", "畠山成"}},
			...
			{{""}, {"27"}, {"村田顕弘六段"}, {"4"}, {"4"}, {"●", "門倉"}, {"○", "佐藤和"}, {"○", "飯塚"}, {"●", "宮田"}, {"○", "真田"}, {"－"}, {"○", "千葉"}, {"●", "服部"}, {"●", "伊藤匠"}, {"先", "阪口"}, {"", "船江"}},
			{{""}, {"28"}, {"高橋道雄九段"}, {"2"}, {"6"}, {"○", "阪口"}, {"○", "三枚堂"}, {"●", "先崎"}, {"●", "北島"}, {"－"}, {"●", "古森"}, {"●", "宮本"}, {"●", "千葉"}, {"●", "服部"}, {"", "黒田"}, {"先", "片上"}},
			{{""}, {"29"}, {"畠山成幸八段"}, {"3"}, {"5"}, {"●", "西田"}, {"●", "古森"}, {"●", "服部"}, {"●", "黒田"}, {"－"}, {"○", "片上"}, {"○", "船江"}, {"○", "門倉"}, {"●", "都成"}, {"", "真田"}, {"先", "金井"}},
			{{""}, {"30"}, {"千葉幸生七段"}, {"3"}, {"5"}, {"●", "金井"}, {"○", "日浦"}, {"●", "斎藤明"}, {"●", "宮本"}, {"－"}, {"○", "西尾"}, {"●", "村田顕"}, {"○", "高橋"}, {"●", "阿部健"}, {"先", "船江"}, {"", "先崎"}},
			{{""}, {"31"}, {"日浦市郎八段"}, {"1"}, {"8"}, {"●", "宮田"}, {"●", "千葉"}, {"●", "古森"}, {"●", "金井"}, {"●", "佐藤和"}, {"○", "飯塚"}, {"●", "斎藤明"}, {"●", "西尾"}, {"●", "西田"}, {"先", "三枚堂"}, {"－"}},
		}
		assert.Equal(t, expectedTable, result.Table)
	}
}
